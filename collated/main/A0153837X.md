...
###### /src/main/java/seedu/tasklist/logic/commands/TimeCommand.java
``` java
...
```
###### /src/main/java/seedu/tasklist/model/ModelManager.java
``` java
    @Override
...
```
###### /src/main/java/seedu/tasklist/model/task/Date.java
``` java
...
```
###### /src/main/java/seedu/tasklist/model/task/DateTime.java
``` java
...
```
###### /src/main/java/seedu/tasklist/model/task/Task.java
``` java
...
```
###### /src/main/java/seedu/tasklist/model/task/Time.java
``` java
...
```
###### /src/test/java/guitests/TimeCommandTest.java
``` java
